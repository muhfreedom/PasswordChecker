...
function Parse_Common9()
{
   ...
   {
      window.setTimeout('Parse_Common9()', 20);
   }
   else
   {
...
// number for "qu".
function Parse_Frequency_Token9()
{
   var c;
...
function Get_Charset_Size9(pass)
{
...
function Set_Text9(s)
{
   ...
   e = document.getElementById('passchk_result9');
   if (! e)
   {
      return;
   }
...
function ShowStats9()
{
   ...
   if (pass == OldPass9)
   {
      window.setTimeout('ShowStats9();', 200);
      return;
   }
   OldPass9 = pass;
   ...
   if (pass.length > 1)
   {
      ...
      charSet = Math.log(Get_Charset_Size9(pass)) / Math.log(2);
      aidx = Get_Index9(plower.charAt(0));
      for (var b = 1; b < plower.length; b ++)
      {
	 var bidx = Get_Index9(plower.charAt(b));
...
function CheckIfLoaded9()
{
   ...
   else if (! document.Common_Parsed)
   {
      ...
      {
         window.setTimeout('Parse_Common9()', 50);
   ...
   {
      Set_Text9(s + "Loading ...");
      window.setTimeout('CheckIfLoaded9()', 200);
      return;
   }
   
   // Loaded. Do initialization thingies.
   Set_Text9("Finished Loading.");
   window.setTimeout('ShowStats9();', 1000);
}

window.setTimeout('CheckIfLoaded9()', 100);

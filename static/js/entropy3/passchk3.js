...
function Parse_Common_Word()
{
   ...
   i = 1;
   c = Common_List3.substr(i, 1);
   while (c == c.toLowerCase() && i < Common_List3.length)
   {
      i ++;
      c = Common_List3.substr(i, 1);
   }
   
   word = Common_List3.substr(0, i);
   Common_List3 = Common_List3.substr(i, Common_List3.length);
...
{
   for (var i = 0; i < 100 && Common_List3.length > 0; i ++)
   {
      Parse_Common_Word();
   }
   if (Common_List3.length)
   {
...
function Parse_Frequency_Token()
{
   ...
   c = Frequency_List3.charCodeAt(0) - ' '.charCodeAt(0);
   c /= 95;
   c += Frequency_List3.charCodeAt(1) - ' '.charCodeAt(0);
   c /= 95;
   c += Frequency_List3.charCodeAt(2) - ' '.charCodeAt(0);
   c /= 95;
   
   Frequency_List3 = Frequency_List3.substr(3, Frequency_List3.length);
...
{
   for (var i = 0; i < 100 && Frequency_List3.length > 0; i ++)
   {
      Parse_Frequency_Token();
   }
   if (Frequency_List3.length)
   {
...
function ShowStats()
{
   var pass = document.passchk_form3.passchk_pass3.value;
   ...
   else if (! document.Common_Parsed)
   {
	 ...
	 document.Common_Parsed_Started = 1;
      ...
      s += "Parsing common passwords... " + 
         Common_List3.length + "<br>\n";
   }
   if (! document.Frequency_Loaded3)
   {
